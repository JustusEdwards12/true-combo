...
1. Win neutral with **safe pokes** and movement baits.
2. Build **advantage** with corner and platform routes—read [advantage basics](/guides/improve-advantage-state).
3. Treat Arsene as a **clock**—pressure with intent, not panic.
