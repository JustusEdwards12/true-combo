...
keyTakeaways:
  - "Approach zoners by contesting space patiently rather than forcing full-screen commitments."
  - "Use movement feints and shield discipline to make projectile patterns punishable."
  - "Once in range, keep pressure tight so the zoner cannot reset to their preferred distance."
...
- Dashing in after every block instead of holding [stage control](/glossary/stage-control).
...
- Hold center and threaten intercept at [burst range](/glossary/burst-range).
